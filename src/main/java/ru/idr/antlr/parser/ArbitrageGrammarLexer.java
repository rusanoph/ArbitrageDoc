...
public class ArbitrageGrammarLexer extends Lexer {
	...
	public ArbitrageGrammarLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "ArbitrageGrammar.g4"; }
