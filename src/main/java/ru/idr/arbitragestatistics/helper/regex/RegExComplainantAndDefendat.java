...
public class RegExComplainantAndDefendat {
    ...
    // ======= Пояснения к классу =======
    // Здесь была предпринята попытка на 
    // основе текста выявить общий паттерн регулярного выражения
    // для различных шаблонов заявлений.
    // Глобально тектсы делятся на два типа: 
    //     с наличием идентификации (ИНН, ОГРН, и тп)
    //     без идентификации (названия/имена и прочие нечеткие текстовые данные)
    // Попытка не удачная :)
    // ==================================
